...
export const infos = {
  ...
  whatsappDefaultMessage:
    "Mensagem pro Whatsapp: Olá! Vim do Google e preciso falar com uma Advogada Previdenciarista. Pode me ajudar?",
...
const content = {
  texts: {
    ...
    about: {
      ...
      DestaquePartTitle: (
        <p>
          <span className="italic"> atuação</span>{" "}
        </p>
      ),
      SecondPartTitle: "",
      subtitle: "",
    ...
    ctaSecondary: {
      ...
      subtitle:
        "Muitos benefícios são negados por falta de orientação. Não deixe isso acontecer com você.",
      subtitleDireita: (
